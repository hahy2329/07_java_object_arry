...
public class ObjectArrayEx08_풀이2 {
	...
	public static void main(String[] args) {
		...
		Student8_풀이2[] studentList = new Student8_풀이2[3];
		...
		while(true) {
			...
			if(choice == 1) {
				...
				studentList[studentCnt] = new Student8_풀이2();
				...
				if(studentList[select].subjects == null) {
					...
					studentList[select].subjects = new Subject8_풀이2[1];
					studentList[select].subjects[0] = new Subject8_풀이2();
					...
					Subject8_풀이2[] temp = studentList[select].subjects;
					studentList[select].subjects = new Subject8_풀이2[size + 1];
					...
					studentList[select].subjects[size] = new Subject8_풀이2();
